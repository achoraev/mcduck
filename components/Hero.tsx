    ...
    <div>
      ...
      <div className="flex flex-col gap-6 max-w-md">
        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          <button onClick={() => copy(CONTRACT_ADDRESS)} className="flex items-center gap-3 px-4 py-2 bg-orange-500/5 border border-orange-500/20 rounded-xl hover:bg-orange-500/10 transition-all">
